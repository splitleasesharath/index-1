...
const defaultColumns = [
  {
    ...
    links: [
      ...
      { text: 'Guarantees', url: 'https://app.split.lease/host-guarantees' },
  ...
  },
  {
    title: 'Company',
    links: [
      { text: 'About Periodic Tenancy', url: 'https://app.split.lease/periodic-tenancy' },
      { text: 'About the Team', url: 'https://app.split.lease/team' },
      { text: 'Careers at Split Lease', url: 'https://app.split.lease/careers' },
      { text: 'View Blog', url: 'https://app.split.lease/blog' }
    ]
  }
];
              ...
              <div className="referral-options">
                <label>
                  <input
                    ...
                    onChange={(e) => setReferralMethod(e.target.value)}
                  />
                  Text
                </label>
                <label>
